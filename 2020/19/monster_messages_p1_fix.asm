...
; this should be fully correct algorithm AFAIK, traversing whole possible options tree
...
;                     DISPLAY "Traversing through expanded node ",node," to [",{node + S_NODE.NA},",",{node + S_NODE.NB},"] choice: ",/D,{b choice}
